...
export interface CreateProductResponse {
    /**
     * @generated from protobuf field: common.BaseResponse base_response = 1
     */
...
class CreateProductResponse$Type extends MessageType<CreateProductResponse> {
    constructor() {
        super("product.CreateProductResponse", [
            { no: 1, name: "base_response", kind: "message", T: () => BaseResponse },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateProductResponse): CreateProductResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* common.BaseResponse base_response */ 1:
                    message.baseResponse = BaseResponse.internalBinaryRead(reader, reader.uint32(), options, message.baseResponse);
                    break;
                case /* string id */ 2:
    ...
    internalBinaryWrite(message: CreateProductResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.baseResponse)
            BaseResponse.internalBinaryWrite(message.baseResponse, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string id = 2; */
        if (message.id !== "")
